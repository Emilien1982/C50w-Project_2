...
class Bid(models.Model):
    auction = models.ForeignKey(Auction, on_delete=models.CASCADE, related_name="bided")
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="bider")
    date = models.DateTimeField(auto_now_add=True)
    price = models.IntegerField()

class Comment(models.Model):
    auction = models.ForeignKey(Auction, on_delete=models.DO_NOTHING, related_name="commented")
